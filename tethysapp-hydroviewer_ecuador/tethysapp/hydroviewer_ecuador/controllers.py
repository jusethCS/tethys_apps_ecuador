...
@controller(name='home',url='hydroviewer-ecuador')
def home(request):
...
def get_data(request):
    ...
    return render(request, 'hydroviewer_ecuador/panel.html', context) 



# Return streamflow station (in geojson format) 
@controller(name='get_raw_forecast_date',url='hydroviewer-ecuador/get-raw-forecast-date')
