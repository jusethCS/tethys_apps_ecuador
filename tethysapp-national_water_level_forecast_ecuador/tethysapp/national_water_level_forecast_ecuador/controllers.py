...
@controller(name='get_stations',url='national-water-level-forecast-ecuador/get-stations')
...
@controller(name='get_data',url='national-water-level-forecast-ecuador/get-data')
...
@controller(name='get_metrics_custom',url='national-water-level-forecast-ecuador/get-metrics-custom')
...
@controller(name='get_raw_forecast_date',url='national-water-level-forecast-ecuador/get-raw-forecast-date')
